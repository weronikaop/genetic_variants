#!/bin/bash
# ================================================
#  Evolutionary Pattern Analysis Pipeline
# ================================================
...
for idx in "${!TREE_FILES[@]}"; do
    ...
    # Step 3: Merge (topology + motif) for this gene
    ...
    # Step 4: Evolutionary pattern recognition - summary
